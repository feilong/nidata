...
class Dataset(object):
    def __init__(self, name, dl_source, space, flavor, fp_version='21.0.2'):
        self.name = name
...
class ForrestDataset(Dataset):
    ...
    def get_data(
        ...
        fn = os.path.join(f'{self.name}_{self.fp_version}', space, *flavor, f'{sid}_{task}_{run:02d}_{lr}h.npy')
